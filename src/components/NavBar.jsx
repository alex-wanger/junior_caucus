                        ...
                        <div className="ml-10 flex items-baseline space-x-4">
                            {pages.map(({ path, label }) => (
                                <Link
                                    key={path}
                                    to={path}
                                    className={`px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${location.pathname === path
                    ...
                    <div className="px-2 pt-2 pb-3 space-y-1">
                        {pages.map(({ path, label }) => (
                            <Link
                                ...
                                className={`block w-full text-left px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${location.pathname === path
                                        ? "bg-pink-500 text-white"
                                        : "text-gray-700 hover:text-pink-500 hover:bg-pink-50"
                                    }`}
                            >
