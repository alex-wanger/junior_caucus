                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
                  <div className="text-center text-white px-4">
                    ...
                    <p className="text-xl md:text-2xl drop-shadow-md">
                      New York City runs on the subway, but your junior year
                      runs on us.
                    </p>
                  </div>
                </div>
                ...
                <div className="px-4 md:px-8">
                  <div className="max-w-4xl">
                    ...
                    <p className="text-base md:text-lg">
                      The Junior Caucus aims to serve as a proactive and
                      dedicated body for the junior class, promoting community,
                      collaboration, and student engagement. By offering
                      resources, hosting events, and advocating for students,
                      the Junior Caucus strives to create a supportive
                      environment where students can succeed academically,
                      connect socially, and enjoy a meaningful and memorable
                      junior year.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="grid md:grid-cols-3 gap-8">
                    ...
                    >
                      ...
                      <p className="text-gray-600 group-hover:text-gray-700 transition-colors">
                        From workshops to fundraisers, stay connected with
                        events that support our class, ease the stress of junior
                        year, and bring our community together.
                      </p>
                    ...
                    >
                      ...
                      <p className="text-gray-600 group-hover:text-gray-700 transition-colors">
                        Get ready for the highlight of our junior year! Find
                        updates on themes, ticket info, and the yacht that make
                        JProm an unforgettable experience.
                      </p>
                    ...
                    >
                      ...
                      <p className="text-gray-600 group-hover:text-gray-700 transition-colors">
                        From study guides to college prep, explore resources
                        designed to support you through academics, career
                  ...
                  <div className="grid md:grid-cols-1 gap-8">
                    ...
                    >
                      ...
                      <p className="text-gray-600 group-hover:text-gray-700 transition-colors mb-4">
                        Get to know the dedicated students working hard to make
                        your junior year amazing. Learn about our cabinet
                        members, their roles, and how they're here to support
                        you.
                      </p>
