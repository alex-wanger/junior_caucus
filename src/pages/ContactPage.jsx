          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-pink-100">
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <div key={index} className={`${info.bgColor} rounded-lg p-4 border ${info.borderColor}`}>
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-purple-100">
            ...
            <div className="space-y-6">
              {locations.map((location, index) => (
                <div key={index} className={`${location.bgColor} rounded-lg p-4 border ${location.borderColor}`}>
            ...
            <div className="mt-8">
              <h3 className="font-semibold text-gray-800 mb-4">Suggestion Box</h3>
              <div className="bg-gradient-to-r from-pink-50 to-purple-50 rounded-lg p-6 border border-pink-200">
                <p className="text-gray-700 mb-4">Have ideas or feedback? We want to hear from you!</p>
                <p className="text-gray-600 text-sm italic">
                  Suggestion box form coming soon - stay tuned for ways to share your thoughts with us.
                </p>
              </div>
            </div>
          </div>
